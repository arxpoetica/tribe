...
async function start() {
	...
	app.listen(process.env.PORT, setTimeout(() => {
		...
		console.log('\n\n')
		console.log('           _'.red + 'm'.blue + '_'.red + '       ~O             ' + 'O'.red)
		console.log('         /\\___\\'.red + '      <|\\       ' + '~o/ '.magenta + '/|\\'.red + ' \\o            ' + '~o__'.yellow + '   _o'.red)
		console.log('         |_|'.red + '""'.yellow + '|'.red + '       |\\      ' + ' /|   '.magenta + '|\\'.red + '  |\\           ' + '/|'.yellow + '      |\\'.red + '    Tribe' + (process.env.appName ? ' | ' + process.env.appName.magenta : ''))
		console.log('     ___/______\\_____'.green + '/' + '_'.green + '|' + '_______'.green + '/'.magenta + '_'.green + '\\'.magenta + '_'.green + '/'.red + '_'.green + '|'.red + '_'.green + '/' + '_'.green + '>' + '___________'.green + '/'.yellow + '_'.green + '\\'.yellow + '____'.green + '/'.red + '_'.green + '>'.red + '_____________'.green + (process.env.appName ? (new Array(process.env.appName.length).join('_') + '___').green : ''))
		console.log('\n\n')
